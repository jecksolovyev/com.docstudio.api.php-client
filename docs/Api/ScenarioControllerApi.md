# Swagger\Client\ScenarioControllerApi
...
# **cloneScenario**
> \Swagger\Client\Model\ScenarioDTO cloneScenario($scenario_uuid, $mailbox)
...
$apiInstance = new Swagger\Client\Api\ScenarioControllerApi(
...
[**\Swagger\Client\Model\ScenarioDTO**](../Model/ScenarioDTO.md)
...
# **createNewScenario**
> \Swagger\Client\Model\ScenarioDTO createNewScenario($body, $mailbox)
...
$body = new \Swagger\Client\Model\ScenarioDTO(); // \Swagger\Client\Model\ScenarioDTO | 
$mailbox = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Mailbox context, HTTP Header with current mailbox UUID
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ScenarioDTO**](../Model/ScenarioDTO.md)|  |
 **mailbox** | [**string**](../Model/.md)| Mailbox context, HTTP Header with current mailbox UUID |
...
# **getScenario**
> \Swagger\Client\Model\ScenarioDTO getScenario($scenario_uuid, $mailbox)
...
# **runScenario**
> \Swagger\Client\Model\SingleUuidDTO runScenario($scenario_uuid, $mailbox)
...
# **searchScenarios**
> \Swagger\Client\Model\PageDTOScenarioShortDTO searchScenarios($mailbox, $level, $keyword, $offset, $limit)
...
[**\Swagger\Client\Model\PageDTOScenarioShortDTO**](../Model/PageDTOScenarioShortDTO.md)
...
# **updateScenario**
> \Swagger\Client\Model\ScenarioDTO updateScenario($body, $mailbox, $scenario_uuid)
