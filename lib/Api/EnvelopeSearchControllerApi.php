...
class EnvelopeSearchControllerApi
{
    ...
    /**
     * Operation resetColumnSettings
     *
     * Reset column settings
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resetColumnSettings'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\EnvelopeViewColumn[]
     */
    public function resetColumnSettings($mailbox, string $contentType = self::contentTypes['resetColumnSettings'][0])
    {
        list($response) = $this->resetColumnSettingsWithHttpInfo($mailbox, $contentType);
        return $response;
    }

    /**
     * Operation resetColumnSettingsWithHttpInfo
     *
     * Reset column settings
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\EnvelopeViewColumn[], HTTP status code, HTTP response headers (array of strings)
     */
    public function resetColumnSettingsWithHttpInfo($mailbox, string $contentType = self::contentTypes['resetColumnSettings'][0])
    {
        $request = $this->resetColumnSettingsRequest($mailbox, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DocStudio\Client\Model\EnvelopeViewColumn[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DocStudio\Client\Model\EnvelopeViewColumn[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DocStudio\Client\Model\EnvelopeViewColumn[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\DocStudio\Client\Model\EnvelopeViewColumn[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DocStudio\Client\Model\EnvelopeViewColumn[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation resetColumnSettingsAsync
     *
     * Reset column settings
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetColumnSettingsAsync($mailbox, string $contentType = self::contentTypes['resetColumnSettings'][0])
    {
        return $this->resetColumnSettingsAsyncWithHttpInfo($mailbox, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resetColumnSettingsAsyncWithHttpInfo
     *
     * Reset column settings
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetColumnSettingsAsyncWithHttpInfo($mailbox, string $contentType = self::contentTypes['resetColumnSettings'][0])
    {
        $returnType = '\DocStudio\Client\Model\EnvelopeViewColumn[]';
        $request = $this->resetColumnSettingsRequest($mailbox, $contentType);
    ...
    /**
     * Create request for operation 'resetColumnSettings'
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resetColumnSettings'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetColumnSettingsRequest($mailbox, string $contentType = self::contentTypes['resetColumnSettings'][0])
    {

        // verify the required parameter 'mailbox' is set
        if ($mailbox === null || (is_array($mailbox) && count($mailbox) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $mailbox when calling resetColumnSettings'
            );
        }


        $resourcePath = '/api/v1/envelope/column-reset';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  \DocStudio\Client\Model\SearchEnvelopesDTO $search_envelopes_dto search_envelopes_dto (required)
     * @param  int|null $offset Offset, how many envelopes to skip (optional, default to 0)
     * @param  int|null $limit Limit, how many envelopes to retrieve (optional, default to 25)
     * @param  bool|null $uuid_only Retrieve only UUID of envelope (optional)
     ...
     */
    public function searchEnvelopesForApproval($mailbox, $search_approvals_dto, $offset = 0, $limit = 25, $uuid_only = null, string $contentType = self::contentTypes['searchEnvelopesForApproval'][0])
    {
        list($response) = $this->searchEnvelopesForApprovalWithHttpInfo($mailbox, $search_approvals_dto, $offset, $limit, $uuid_only, $contentType);
        return $response;
    }
     ...
     */
    public function searchEnvelopesForApprovalWithHttpInfo($mailbox, $search_approvals_dto, $offset = 0, $limit = 25, $uuid_only = null, string $contentType = self::contentTypes['searchEnvelopesForApproval'][0])
    {
        $request = $this->searchEnvelopesForApprovalRequest($mailbox, $search_approvals_dto, $offset, $limit, $uuid_only, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchEnvelopesForApprovalAsync($mailbox, $search_approvals_dto, $offset = 0, $limit = 25, $uuid_only = null, string $contentType = self::contentTypes['searchEnvelopesForApproval'][0])
    {
        return $this->searchEnvelopesForApprovalAsyncWithHttpInfo($mailbox, $search_approvals_dto, $offset, $limit, $uuid_only, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchEnvelopesForApprovalAsyncWithHttpInfo($mailbox, $search_approvals_dto, $offset = 0, $limit = 25, $uuid_only = null, string $contentType = self::contentTypes['searchEnvelopesForApproval'][0])
    {
        $returnType = '\DocStudio\Client\Model\EnvelopeApprovalPageDTO';
        $request = $this->searchEnvelopesForApprovalRequest($mailbox, $search_approvals_dto, $offset, $limit, $uuid_only, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchEnvelopesForApprovalRequest($mailbox, $search_approvals_dto, $offset = 0, $limit = 25, $uuid_only = null, string $contentType = self::contentTypes['searchEnvelopesForApproval'][0])
    {
