...
class UserControllerApi
{
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return map[string,\DocStudio\Client\Model\UserInfoDTO]
     */
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of map[string,\DocStudio\Client\Model\UserInfoDTO], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMailboxesInfoWithHttpInfo($body)
    {
        $returnType = 'map[string,\DocStudio\Client\Model\UserInfoDTO]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'map[string,\DocStudio\Client\Model\UserInfoDTO]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
