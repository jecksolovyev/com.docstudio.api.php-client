...
class MailboxGroupControllerApi
{
     ...
     *
     * @param  string $account_uuid Account UUID (required)
     * @param  string|null $keyword Keyword to search group by or group UUID (optional)
     ...
     * @param  bool|null $asc Sort by name in ASC order (optional, default to true)
     ...
     * @return void
     */
    public function updateMailboxGroup($account_uuid, $group_uuid, string $contentType = self::contentTypes['updateMailboxGroup'][0])
    {
        $this->updateMailboxGroupWithHttpInfo($account_uuid, $group_uuid, $contentType);
    }
     ...
     */
    public function updateMailboxGroupWithHttpInfo($account_uuid, $group_uuid, string $contentType = self::contentTypes['updateMailboxGroup'][0])
    {
        $request = $this->updateMailboxGroupRequest($account_uuid, $group_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMailboxGroupAsync($account_uuid, $group_uuid, string $contentType = self::contentTypes['updateMailboxGroup'][0])
    {
        return $this->updateMailboxGroupAsyncWithHttpInfo($account_uuid, $group_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMailboxGroupAsyncWithHttpInfo($account_uuid, $group_uuid, string $contentType = self::contentTypes['updateMailboxGroup'][0])
    {
        $returnType = '';
        $request = $this->updateMailboxGroupRequest($account_uuid, $group_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateMailboxGroupRequest($account_uuid, $group_uuid, string $contentType = self::contentTypes['updateMailboxGroup'][0])
    {
     ...
     * @return \DocStudio\Client\Model\GroupInfoDTO
     */
    public function updateMailboxGroupMailboxGroup($account_uuid, $group_uuid, $update_group_dto, string $contentType = self::contentTypes['updateMailboxGroupMailboxGroup'][0])
    {
        list($response) = $this->updateMailboxGroupMailboxGroupWithHttpInfo($account_uuid, $group_uuid, $update_group_dto, $contentType);
        return $response;
    }
     ...
     * @return array of \DocStudio\Client\Model\GroupInfoDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMailboxGroupMailboxGroupWithHttpInfo($account_uuid, $group_uuid, $update_group_dto, string $contentType = self::contentTypes['updateMailboxGroupMailboxGroup'][0])
    {
        $request = $this->updateMailboxGroupMailboxGroupRequest($account_uuid, $group_uuid, $update_group_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMailboxGroupMailboxGroupAsync($account_uuid, $group_uuid, $update_group_dto, string $contentType = self::contentTypes['updateMailboxGroupMailboxGroup'][0])
    {
        return $this->updateMailboxGroupMailboxGroupAsyncWithHttpInfo($account_uuid, $group_uuid, $update_group_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMailboxGroupMailboxGroupAsyncWithHttpInfo($account_uuid, $group_uuid, $update_group_dto, string $contentType = self::contentTypes['updateMailboxGroupMailboxGroup'][0])
    {
        $returnType = '\DocStudio\Client\Model\GroupInfoDTO';
        $request = $this->updateMailboxGroupMailboxGroupRequest($account_uuid, $group_uuid, $update_group_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateMailboxGroupMailboxGroupRequest($account_uuid, $group_uuid, $update_group_dto, string $contentType = self::contentTypes['updateMailboxGroupMailboxGroup'][0])
    {
        ...
        if ($update_group_dto === null || (is_array($update_group_dto) && count($update_group_dto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_group_dto when calling updateMailboxGroupMailboxGroup'
            );
        }
