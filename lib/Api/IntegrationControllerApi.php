...
class IntegrationControllerApi
{
     ...
     * @return string
     */
    public function convertBinaryToXML($filename, $mailbox_uuid, $request_body = null, string $contentType = self::contentTypes['convertBinaryToXML'][0])
    {
        list($response) = $this->convertBinaryToXMLWithHttpInfo($filename, $mailbox_uuid, $request_body, $contentType);
        return $response;
    }
     ...
     */
    public function convertBinaryToXMLWithHttpInfo($filename, $mailbox_uuid, $request_body = null, string $contentType = self::contentTypes['convertBinaryToXML'][0])
    {
        $request = $this->convertBinaryToXMLRequest($filename, $mailbox_uuid, $request_body, $contentType);
     ...
     */
    public function convertBinaryToXMLAsync($filename, $mailbox_uuid, $request_body = null, string $contentType = self::contentTypes['convertBinaryToXML'][0])
    {
        return $this->convertBinaryToXMLAsyncWithHttpInfo($filename, $mailbox_uuid, $request_body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function convertBinaryToXMLAsyncWithHttpInfo($filename, $mailbox_uuid, $request_body = null, string $contentType = self::contentTypes['convertBinaryToXML'][0])
    {
        $returnType = 'string';
        $request = $this->convertBinaryToXMLRequest($filename, $mailbox_uuid, $request_body, $contentType);
     ...
     */
    public function convertBinaryToXMLRequest($filename, $mailbox_uuid, $request_body = null, string $contentType = self::contentTypes['convertBinaryToXML'][0])
    {
