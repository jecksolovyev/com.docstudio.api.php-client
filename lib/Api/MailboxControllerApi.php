...
class MailboxControllerApi
{
     ...
     * @param  string|null $code Invitation code from email (optional)
     * @param  string|null $code_type Type of code (optional)
     ...
     * @param  string|null $move_entities_to_mailbox Move entities to chosen mailbox (optional)
     ...
     * @return void
     */
    public function deleteMailbox($check_message, $mailbox, $move_entities_to_mailbox = null, string $contentType = self::contentTypes['deleteMailbox'][0])
    {
        $this->deleteMailboxWithHttpInfo($check_message, $mailbox, $move_entities_to_mailbox, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteMailboxWithHttpInfo($check_message, $mailbox, $move_entities_to_mailbox = null, string $contentType = self::contentTypes['deleteMailbox'][0])
    {
        $request = $this->deleteMailboxRequest($check_message, $mailbox, $move_entities_to_mailbox, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteMailboxAsync($check_message, $mailbox, $move_entities_to_mailbox = null, string $contentType = self::contentTypes['deleteMailbox'][0])
    {
        return $this->deleteMailboxAsyncWithHttpInfo($check_message, $mailbox, $move_entities_to_mailbox, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteMailboxAsyncWithHttpInfo($check_message, $mailbox, $move_entities_to_mailbox = null, string $contentType = self::contentTypes['deleteMailbox'][0])
    {
        $returnType = '';
        $request = $this->deleteMailboxRequest($check_message, $mailbox, $move_entities_to_mailbox, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteMailboxRequest($check_message, $mailbox, $move_entities_to_mailbox = null, string $contentType = self::contentTypes['deleteMailbox'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $move_entities_to_mailbox,
            'moveEntitiesToMailbox', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $from A datetime value in &#39;ISO-8601&#39; format, lowest record date, default - 3 days ago (optional)
     * @param  string|null $to A datetime value in &#39;ISO-8601&#39; format, highest record date, default - now (optional)
     * @param  int|null $offset Offset, how much records to skip (optional, default to 0)
     * @param  int|null $limit Limit, how much records to retrieve, max is 1000 (optional, default to 25)
     ...
     * @param  bool|null $account_name Including account name (optional, default to false)
     * @param  bool|null $account_itn Including account ITN (optional, default to false)
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $name Template name to search by (optional)
    ...
    /**
     * Operation leaveMailbox
     *
     * Leave mailbox if possible
     *
     * @param  string $mailbox_uuid mailbox_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leaveMailbox'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function leaveMailbox($mailbox_uuid, string $contentType = self::contentTypes['leaveMailbox'][0])
    {
        $this->leaveMailboxWithHttpInfo($mailbox_uuid, $contentType);
    }

    /**
     * Operation leaveMailboxWithHttpInfo
     *
     * Leave mailbox if possible
     *
     * @param  string $mailbox_uuid (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function leaveMailboxWithHttpInfo($mailbox_uuid, string $contentType = self::contentTypes['leaveMailbox'][0])
    {
        $request = $this->leaveMailboxRequest($mailbox_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leaveMailboxAsync($mailbox_uuid, string $contentType = self::contentTypes['leaveMailbox'][0])
    {
        return $this->leaveMailboxAsyncWithHttpInfo($mailbox_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leaveMailboxAsyncWithHttpInfo
     *
     * Leave mailbox if possible
     *
     * @param  string $mailbox_uuid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leaveMailboxAsyncWithHttpInfo($mailbox_uuid, string $contentType = self::contentTypes['leaveMailbox'][0])
    {
        $returnType = '';
        $request = $this->leaveMailboxRequest($mailbox_uuid, $contentType);
    ...
    /**
     * Create request for operation 'leaveMailbox'
     *
     * @param  string $mailbox_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leaveMailbox'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function leaveMailboxRequest($mailbox_uuid, string $contentType = self::contentTypes['leaveMailbox'][0])
    {

        // verify the required parameter 'mailbox_uuid' is set
        if ($mailbox_uuid === null || (is_array($mailbox_uuid) && count($mailbox_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $mailbox_uuid when calling leaveMailbox'
            );
        }


        $resourcePath = '/api/v1/mailbox/{mailboxUuid}/leave';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $type Search type: name, alias or uuid. Default - all values (optional)
