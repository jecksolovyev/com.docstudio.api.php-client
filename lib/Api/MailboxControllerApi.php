...
class MailboxControllerApi
{
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return map[string,\DocStudio\Client\Model\MailboxInfoDTO]
     */
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of map[string,\DocStudio\Client\Model\MailboxInfoDTO], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMailboxesInfoMailboxWithHttpInfo($body, $account_name = 'false', $account_itn = 'false')
    {
        $returnType = 'map[string,\DocStudio\Client\Model\MailboxInfoDTO]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'map[string,\DocStudio\Client\Model\MailboxInfoDTO]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
