...
class EnvelopeControllerApi
{
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  \DocStudio\Client\Model\EnvCancelDelegationDTO $env_cancel_delegation_dto env_cancel_delegation_dto (required)
     ...
     * @return void
     */
    public function cancelEnvelopeDelegation($mailbox, $env_cancel_delegation_dto, string $contentType = self::contentTypes['cancelEnvelopeDelegation'][0])
    {
        $this->cancelEnvelopeDelegationWithHttpInfo($mailbox, $env_cancel_delegation_dto, $contentType);
    }
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  \DocStudio\Client\Model\EnvCancelDelegationDTO $env_cancel_delegation_dto (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cancelEnvelopeDelegation'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelEnvelopeDelegationWithHttpInfo($mailbox, $env_cancel_delegation_dto, string $contentType = self::contentTypes['cancelEnvelopeDelegation'][0])
    {
        $request = $this->cancelEnvelopeDelegationRequest($mailbox, $env_cancel_delegation_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelEnvelopeDelegationAsync($mailbox, $env_cancel_delegation_dto, string $contentType = self::contentTypes['cancelEnvelopeDelegation'][0])
    {
        return $this->cancelEnvelopeDelegationAsyncWithHttpInfo($mailbox, $env_cancel_delegation_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelEnvelopeDelegationAsyncWithHttpInfo($mailbox, $env_cancel_delegation_dto, string $contentType = self::contentTypes['cancelEnvelopeDelegation'][0])
    {
        $returnType = '';
        $request = $this->cancelEnvelopeDelegationRequest($mailbox, $env_cancel_delegation_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cancelEnvelopeDelegationRequest($mailbox, $env_cancel_delegation_dto, string $contentType = self::contentTypes['cancelEnvelopeDelegation'][0])
    {
        ...
        // verify the required parameter 'env_cancel_delegation_dto' is set
        if ($env_cancel_delegation_dto === null || (is_array($env_cancel_delegation_dto) && count($env_cancel_delegation_dto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_cancel_delegation_dto when calling cancelEnvelopeDelegation'
            );
        }
        ...
        // for model (json/xml)
        if (isset($env_cancel_delegation_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($env_cancel_delegation_dto));
            } else {
                $httpBody = $env_cancel_delegation_dto;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    {
        $this->cancelEnvelopesWithHttpInfo($mailbox, $env_cancellation_request_dto, $contentType);
    }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEnvelope'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\SingleUuidDTO
     */
    public function createEnvelope($mailbox, $env_post_dto, string $contentType = self::contentTypes['createEnvelope'][0])
    {
        list($response) = $this->createEnvelopeWithHttpInfo($mailbox, $env_post_dto, $contentType);
        return $response;
    }
     ...
     * @return array of \DocStudio\Client\Model\SingleUuidDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function createEnvelopeWithHttpInfo($mailbox, $env_post_dto, string $contentType = self::contentTypes['createEnvelope'][0])
    {
        $request = $this->createEnvelopeRequest($mailbox, $env_post_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEnvelopeAsync($mailbox, $env_post_dto, string $contentType = self::contentTypes['createEnvelope'][0])
    {
        return $this->createEnvelopeAsyncWithHttpInfo($mailbox, $env_post_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEnvelopeAsyncWithHttpInfo($mailbox, $env_post_dto, string $contentType = self::contentTypes['createEnvelope'][0])
    {
        $returnType = '\DocStudio\Client\Model\SingleUuidDTO';
        $request = $this->createEnvelopeRequest($mailbox, $env_post_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createEnvelopeRequest($mailbox, $env_post_dto, string $contentType = self::contentTypes['createEnvelope'][0])
    {
        ...
        if ($env_post_dto === null || (is_array($env_post_dto) && count($env_post_dto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_post_dto when calling createEnvelope'
            );
        }
    ...
    {
        $this->delegateEnvelopesWithHttpInfo($mailbox, $env_delegation_dto, $contentType);
    }
     ...
     * @return void
     */
    public function envelopeApproval($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, string $contentType = self::contentTypes['envelopeApproval'][0])
    {
        $this->envelopeApprovalWithHttpInfo($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function envelopeApprovalWithHttpInfo($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, string $contentType = self::contentTypes['envelopeApproval'][0])
    {
        $request = $this->envelopeApprovalRequest($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function envelopeApprovalAsync($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, string $contentType = self::contentTypes['envelopeApproval'][0])
    {
        return $this->envelopeApprovalAsyncWithHttpInfo($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function envelopeApprovalAsyncWithHttpInfo($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, string $contentType = self::contentTypes['envelopeApproval'][0])
    {
        $returnType = '';
        $request = $this->envelopeApprovalRequest($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function envelopeApprovalRequest($envelope_uuid, $flow_uuid, $mailbox, $approval_status_dto, string $contentType = self::contentTypes['envelopeApproval'][0])
    {
     ...
     */
    public function getDocumentForSign($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentForSign'][0])
    {
        list($response) = $this->getDocumentForSignWithHttpInfo($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, $contentType);
        return $response;
    }
     ...
     */
    public function getDocumentForSignWithHttpInfo($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentForSign'][0])
    {
        $request = $this->getDocumentForSignRequest($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentForSignAsync($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentForSign'][0])
    {
        return $this->getDocumentForSignAsyncWithHttpInfo($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentForSignAsyncWithHttpInfo($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentForSign'][0])
    {
        $returnType = '\DocStudio\Client\Model\DocumentForSigningDTO';
        $request = $this->getDocumentForSignRequest($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDocumentForSignRequest($envelope_uuid, $mailbox, $single_doc_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentForSign'][0])
    {
     ...
     * @return \DocStudio\Client\Model\DocumentForSigningDTO[]
     */
    public function getDocumentsForSign($envelope_uuid, $mailbox, $documents_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentsForSign'][0])
    {
        list($response) = $this->getDocumentsForSignWithHttpInfo($envelope_uuid, $mailbox, $documents_for_sign_request_dto, $contentType);
        return $response;
    }
     ...
     * @return array of \DocStudio\Client\Model\DocumentForSigningDTO[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentsForSignWithHttpInfo($envelope_uuid, $mailbox, $documents_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentsForSign'][0])
    {
        $request = $this->getDocumentsForSignRequest($envelope_uuid, $mailbox, $documents_for_sign_request_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsForSignAsync($envelope_uuid, $mailbox, $documents_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentsForSign'][0])
    {
        return $this->getDocumentsForSignAsyncWithHttpInfo($envelope_uuid, $mailbox, $documents_for_sign_request_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsForSignAsyncWithHttpInfo($envelope_uuid, $mailbox, $documents_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentsForSign'][0])
    {
        $returnType = '\DocStudio\Client\Model\DocumentForSigningDTO[]';
        $request = $this->getDocumentsForSignRequest($envelope_uuid, $mailbox, $documents_for_sign_request_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDocumentsForSignRequest($envelope_uuid, $mailbox, $documents_for_sign_request_dto, string $contentType = self::contentTypes['getDocumentsForSign'][0])
    {
     ...
     * @param  string $zip_structure_name The name of pre-saved zip structure in the template (optional)
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\LoginEnvelopeResponseDTO|\DocStudio\Client\Model\DataMap
     */
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\LoginEnvelopeResponseDTO|\DocStudio\Client\Model\DataMap, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $this->sendForApprovalWithHttpInfo($mailbox, $envelope_approval_request_dto, $contentType);
    }
     ...
     * @return void
     */
    public function sign($envelope_uuid, $mailbox, $envelope_document_signatures_dto, string $contentType = self::contentTypes['sign'][0])
    {
        $this->signWithHttpInfo($envelope_uuid, $mailbox, $envelope_document_signatures_dto, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function signWithHttpInfo($envelope_uuid, $mailbox, $envelope_document_signatures_dto, string $contentType = self::contentTypes['sign'][0])
    {
        $request = $this->signRequest($envelope_uuid, $mailbox, $envelope_document_signatures_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function signAsync($envelope_uuid, $mailbox, $envelope_document_signatures_dto, string $contentType = self::contentTypes['sign'][0])
    {
        return $this->signAsyncWithHttpInfo($envelope_uuid, $mailbox, $envelope_document_signatures_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function signAsyncWithHttpInfo($envelope_uuid, $mailbox, $envelope_document_signatures_dto, string $contentType = self::contentTypes['sign'][0])
    {
        $returnType = '';
        $request = $this->signRequest($envelope_uuid, $mailbox, $envelope_document_signatures_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function signRequest($envelope_uuid, $mailbox, $envelope_document_signatures_dto, string $contentType = self::contentTypes['sign'][0])
    {
