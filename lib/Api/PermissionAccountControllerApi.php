...
class PermissionAccountControllerApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AccountPermissionsDTO
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AccountPermissionsDTO, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \Swagger\Client\Model\BasePermissionsDTO $body body (required)
     * @param  string $user_uuid UUID of User (required)
     * @param  string $account_uuid UUID of account (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * Write user permissions
     *
     * @param  \Swagger\Client\Model\BasePermissionsDTO $body (required)
     * @param  string $user_uuid UUID of User (required)
     * @param  string $account_uuid UUID of account (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
