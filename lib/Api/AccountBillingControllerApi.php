...
class AccountBillingControllerApi
{
     ...
     * @param  \DocStudio\Client\Model\BillingEventType $type type (required)
     ...
     * @param  \DocStudio\Client\Model\BillingEventType $type (required)
     ...
     * @param  string|null $details Include details (optional)
    ...
    /**
     * Operation getAccountBillingStateHeader
     *
     * @param  string $account_uuid account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountBillingStateHeader'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\BillingHeaderState
     */
    public function getAccountBillingStateHeader($account_uuid, string $contentType = self::contentTypes['getAccountBillingStateHeader'][0])
    {
        list($response) = $this->getAccountBillingStateHeaderWithHttpInfo($account_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getAccountBillingStateHeaderWithHttpInfo
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountBillingStateHeader'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\BillingHeaderState, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountBillingStateHeaderWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getAccountBillingStateHeader'][0])
    {
        $request = $this->getAccountBillingStateHeaderRequest($account_uuid, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DocStudio\Client\Model\BillingHeaderState' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DocStudio\Client\Model\BillingHeaderState' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DocStudio\Client\Model\BillingHeaderState', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\DocStudio\Client\Model\BillingHeaderState';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DocStudio\Client\Model\BillingHeaderState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAccountBillingStateHeaderAsync
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountBillingStateHeader'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountBillingStateHeaderAsync($account_uuid, string $contentType = self::contentTypes['getAccountBillingStateHeader'][0])
    {
        return $this->getAccountBillingStateHeaderAsyncWithHttpInfo($account_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountBillingStateHeaderAsyncWithHttpInfo
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountBillingStateHeader'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountBillingStateHeaderAsyncWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getAccountBillingStateHeader'][0])
    {
        $returnType = '\DocStudio\Client\Model\BillingHeaderState';
        $request = $this->getAccountBillingStateHeaderRequest($account_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getAccountBillingStateHeader'
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountBillingStateHeader'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAccountBillingStateHeaderRequest($account_uuid, string $contentType = self::contentTypes['getAccountBillingStateHeader'][0])
    {

        // verify the required parameter 'account_uuid' is set
        if ($account_uuid === null || (is_array($account_uuid) && count($account_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_uuid when calling getAccountBillingStateHeader'
            );
        }


        $resourcePath = '/api/v1/account/{accountUuid}/billing-state';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCurrencyRates'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\CurrencyRateDTO[]
     */
    public function getCurrencyRates(string $contentType = self::contentTypes['getCurrencyRates'][0])
    {
        list($response) = $this->getCurrencyRatesWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\CurrencyRateDTO[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrencyRatesWithHttpInfo(string $contentType = self::contentTypes['getCurrencyRates'][0])
    {
        $request = $this->getCurrencyRatesRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DocStudio\Client\Model\CurrencyRateDTO[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DocStudio\Client\Model\CurrencyRateDTO[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DocStudio\Client\Model\CurrencyRateDTO[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\DocStudio\Client\Model\CurrencyRateDTO[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DocStudio\Client\Model\CurrencyRateDTO[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCurrencyRatesAsync(string $contentType = self::contentTypes['getCurrencyRates'][0])
    {
        return $this->getCurrencyRatesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCurrencyRatesAsyncWithHttpInfo(string $contentType = self::contentTypes['getCurrencyRates'][0])
    {
        $returnType = '\DocStudio\Client\Model\CurrencyRateDTO[]';
        $request = $this->getCurrencyRatesRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCurrencyRatesRequest(string $contentType = self::contentTypes['getCurrencyRates'][0])
    {


        $resourcePath = '/api/v1/account/currency-rates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPaymentMethodInfo
     *
     * @param  string $account_uuid account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInfo'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\PaymentMethodInfo
     */
    public function getPaymentMethodInfo($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInfo'][0])
    {
        list($response) = $this->getPaymentMethodInfoWithHttpInfo($account_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getPaymentMethodInfoWithHttpInfo
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInfo'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\PaymentMethodInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentMethodInfoWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInfo'][0])
    {
        $request = $this->getPaymentMethodInfoRequest($account_uuid, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DocStudio\Client\Model\PaymentMethodInfo' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DocStudio\Client\Model\PaymentMethodInfo' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DocStudio\Client\Model\PaymentMethodInfo', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\DocStudio\Client\Model\PaymentMethodInfo';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DocStudio\Client\Model\PaymentMethodInfo',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getPaymentMethodInfoAsync
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInfo'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentMethodInfoAsync($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInfo'][0])
    {
        return $this->getPaymentMethodInfoAsyncWithHttpInfo($account_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPaymentMethodInfoAsyncWithHttpInfo
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInfo'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentMethodInfoAsyncWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInfo'][0])
    {
        $returnType = '\DocStudio\Client\Model\PaymentMethodInfo';
        $request = $this->getPaymentMethodInfoRequest($account_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getPaymentMethodInfo'
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInfo'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentMethodInfoRequest($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInfo'][0])
    {

        // verify the required parameter 'account_uuid' is set
        if ($account_uuid === null || (is_array($account_uuid) && count($account_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_uuid when calling getPaymentMethodInfo'
            );
        }


        $resourcePath = '/api/v1/account/{accountUuid}/payment-method';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPaymentMethodInitKey
     *
     * @param  string $account_uuid account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInitKey'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function getPaymentMethodInitKey($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInitKey'][0])
    {
        list($response) = $this->getPaymentMethodInitKeyWithHttpInfo($account_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getPaymentMethodInitKeyWithHttpInfo
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInitKey'] to see the possible values for this operation
     *
     ...
     */
    public function getPaymentMethodInitKeyWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInitKey'][0])
    {
        $request = $this->getPaymentMethodInitKeyRequest($account_uuid, $contentType);
    ...
    /**
     * Operation getPaymentMethodInitKeyAsync
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInitKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentMethodInitKeyAsync($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInitKey'][0])
    {
        return $this->getPaymentMethodInitKeyAsyncWithHttpInfo($account_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPaymentMethodInitKeyAsyncWithHttpInfo
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInitKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentMethodInitKeyAsyncWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInitKey'][0])
    {
        $returnType = 'string';
        $request = $this->getPaymentMethodInitKeyRequest($account_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getPaymentMethodInitKey'
     *
     * @param  string $account_uuid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPaymentMethodInitKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentMethodInitKeyRequest($account_uuid, string $contentType = self::contentTypes['getPaymentMethodInitKey'][0])
    {

        // verify the required parameter 'account_uuid' is set
        if ($account_uuid === null || (is_array($account_uuid) && count($account_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_uuid when calling getPaymentMethodInitKey'
            );
        }


        $resourcePath = '/api/v1/account/{accountUuid}/payment-method-init';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DocStudio\Client\Model\ChangeAccountTariffResponse
     */
    ...
    {
        list($response) = $this->replaceAccountTariffWithHttpInfo($account_uuid, $replace_account_tariff_dto, $contentType);
        return $response;
    }
     ...
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\ChangeAccountTariffResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function replaceAccountTariffWithHttpInfo($account_uuid, $replace_account_tariff_dto, string $contentType = self::contentTypes['replaceAccountTariff'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DocStudio\Client\Model\ChangeAccountTariffResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DocStudio\Client\Model\ChangeAccountTariffResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DocStudio\Client\Model\ChangeAccountTariffResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\DocStudio\Client\Model\ChangeAccountTariffResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DocStudio\Client\Model\ChangeAccountTariffResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
