...
class DictionaryControllerApi
{
     ...
     * @param  string $dictionary_uuid UUID of dictionary (required)
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  bool|null $with_columns Add columns description to each dictionary (optional, default to false)
     * @param  bool|null $with_records_count Add records count value to each dictionary (optional, default to false)
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $level Dictionary access level, &#39;pub&#39; by default. (optional, default to 'pub')
     * @param  string|null $keyword Keyword to search dictionary by or dictionary UUID (optional)
     * @param  bool|null $with_columns Add columns description to each dictionary (optional, default to false)
     * @param  int|null $offset Offset records (optional, default to 0)
     * @param  int|null $limit Limit records, max is 1000 (optional, default to 25)
