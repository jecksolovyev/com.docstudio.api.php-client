...
class TemplateControllerApi
{
     ...
     * @param  string|null $template_version UUID of version (optional)
     ...
     * @param  string|null $envelope_uuid Envelope UUID (optional)
     * @param  bool|null $clear_fields Clear non-readonly fields (optional)
     * @param  string|null $mailbox Mailbox context, HTTP Header with current mailbox UUID (optional)
     ...
     * @param  string $uuid UUID of template (required)
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  bool|null $generate Code has to be re-generated if exists (optional)
     ...
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $template_version UUID of version (optional)
     * @param  bool|null $check_envelope_creation Check if envelope can be created using this template (optional)
     ...
     * @return \DocStudio\Client\Model\FullTemplateResponseDTO
     */
    public function getTemplateByUuid($uuid, $mailbox, $template_version = null, $check_envelope_creation = null, string $contentType = self::contentTypes['getTemplateByUuid'][0])
    {
        list($response) = $this->getTemplateByUuidWithHttpInfo($uuid, $mailbox, $template_version, $check_envelope_creation, $contentType);
        return $response;
    }
     ...
     * @return array of \DocStudio\Client\Model\FullTemplateResponseDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTemplateByUuidWithHttpInfo($uuid, $mailbox, $template_version = null, $check_envelope_creation = null, string $contentType = self::contentTypes['getTemplateByUuid'][0])
    {
        $request = $this->getTemplateByUuidRequest($uuid, $mailbox, $template_version, $check_envelope_creation, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplateByUuidAsync($uuid, $mailbox, $template_version = null, $check_envelope_creation = null, string $contentType = self::contentTypes['getTemplateByUuid'][0])
    {
        return $this->getTemplateByUuidAsyncWithHttpInfo($uuid, $mailbox, $template_version, $check_envelope_creation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplateByUuidAsyncWithHttpInfo($uuid, $mailbox, $template_version = null, $check_envelope_creation = null, string $contentType = self::contentTypes['getTemplateByUuid'][0])
    {
        $returnType = '\DocStudio\Client\Model\FullTemplateResponseDTO';
        $request = $this->getTemplateByUuidRequest($uuid, $mailbox, $template_version, $check_envelope_creation, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTemplateByUuidRequest($uuid, $mailbox, $template_version = null, $check_envelope_creation = null, string $contentType = self::contentTypes['getTemplateByUuid'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $check_envelope_creation,
            'checkEnvelopeCreation', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  string|null $version_uuid UUID of version, only this one will be returned (optional)
     ...
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $template_version UUID of version (optional)
     * @param  string|null $title Title of zip structure (to mark files as selected) (optional)
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $level Template access level, &#39;pub&#39; by default. (optional, default to 'pub')
     * @param  string|null $keyword Keyword to search template by or template UUID (optional)
     * @param  string|null $category Category id to search template in (optional)
     * @param  bool|null $extended Add extended info to each template (access, account, categories) (optional, default to false)
     * @param  int|null $offset Offset records (optional, default to 0)
     * @param  int|null $limit Limit records, max is 1000 (optional, default to 25)
     ...
     * @param  bool|null $clear_fields Clear non-readonly fields in response PDF (only for PARSE action) (optional)
     ...
     *
     * @param  string $mailbox Mailbox context, HTTP Header with current mailbox UUID (required)
     * @param  string|null $template_uuid UUID of template (optional)
     * @param  string|null $version_uuid Version of template (optional)
