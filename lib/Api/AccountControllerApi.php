...
class AccountControllerApi
{
     ...
     * @param  bool|null $with_users with_users (optional, default to false)
     ...
     * @param  bool|null $with_users (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountDetails'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $account_uuid Account UUID (required)
     * @param  string|null $keyword Keyword to search mailbox by or mailbox UUID (optional)
     * @param  bool|null $with_groups Include groups info into response (optional)
     * @param  string[]|null $group Include groups info into response (optional)
     ...
     *
     * @param  string $uuid uuid (required)
     * @param  \DocStudio\Client\Model\UpdateAccountRequest $update_account_request update_account_request (required)
     ...
     * @return \DocStudio\Client\Model\AccountDTO
     */
    public function updateAccountDetails($uuid, $update_account_request, string $contentType = self::contentTypes['updateAccountDetails'][0])
    {
        list($response) = $this->updateAccountDetailsWithHttpInfo($uuid, $update_account_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $uuid (required)
     * @param  \DocStudio\Client\Model\UpdateAccountRequest $update_account_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateAccountDetails'] to see the possible values for this operation
     *
     * @throws \DocStudio\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DocStudio\Client\Model\AccountDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateAccountDetailsWithHttpInfo($uuid, $update_account_request, string $contentType = self::contentTypes['updateAccountDetails'][0])
    {
        $request = $this->updateAccountDetailsRequest($uuid, $update_account_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAccountDetailsAsync($uuid, $update_account_request, string $contentType = self::contentTypes['updateAccountDetails'][0])
    {
        return $this->updateAccountDetailsAsyncWithHttpInfo($uuid, $update_account_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAccountDetailsAsyncWithHttpInfo($uuid, $update_account_request, string $contentType = self::contentTypes['updateAccountDetails'][0])
    {
        $returnType = '\DocStudio\Client\Model\AccountDTO';
        $request = $this->updateAccountDetailsRequest($uuid, $update_account_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAccountDetailsRequest($uuid, $update_account_request, string $contentType = self::contentTypes['updateAccountDetails'][0])
    {
        ...
        if ($update_account_request === null || (is_array($update_account_request) && count($update_account_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_account_request when calling updateAccountDetails'
            );
        }
