...
class NotificationControllerApi
{
     ...
     * @return array<string,int[]>
     */
    public function getMailboxPreferences($mailbox = null, string $contentType = self::contentTypes['getMailboxPreferences'][0])
    {
        list($response) = $this->getMailboxPreferencesWithHttpInfo($mailbox, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,int[]>, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMailboxPreferencesWithHttpInfo($mailbox = null, string $contentType = self::contentTypes['getMailboxPreferences'][0])
    {
        $request = $this->getMailboxPreferencesRequest($mailbox, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMailboxPreferencesAsync($mailbox = null, string $contentType = self::contentTypes['getMailboxPreferences'][0])
    {
        return $this->getMailboxPreferencesAsyncWithHttpInfo($mailbox, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMailboxPreferencesAsyncWithHttpInfo($mailbox = null, string $contentType = self::contentTypes['getMailboxPreferences'][0])
    {
        $returnType = 'array<string,int[]>';
        $request = $this->getMailboxPreferencesRequest($mailbox, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMailboxPreferencesRequest($mailbox = null, string $contentType = self::contentTypes['getMailboxPreferences'][0])
    {
