 ...
 */
class CreateEnvelopeCallbackDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEnvelopeCallbackDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['timeout'] < 100)) {
            $invalidProperties[] = "invalid value for 'timeout', must be bigger than or equal to 100.";
        }
    ...
    public function setRetries($retries)
    {
        ...
        if (($retries > 10)) {
            throw new \InvalidArgumentException('invalid value for $retries when calling CreateEnvelopeCallbackDTO., must be smaller than or equal to 10.');
        }
        if (($retries < 0)) {
            throw new \InvalidArgumentException('invalid value for $retries when calling CreateEnvelopeCallbackDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (($timeout > 60000)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling CreateEnvelopeCallbackDTO., must be smaller than or equal to 60000.');
        }
        if (($timeout < 100)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling CreateEnvelopeCallbackDTO., must be bigger than or equal to 100.');
        }
     ...
     * Sets login
     *
     * @param string|null $login Basic auth login
     *
     * @return self
     */
