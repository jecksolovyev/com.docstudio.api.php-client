...
/**
 * RecommendedTemplateResponseDTO Class Doc Comment
 *
 * @category Class
 * @package  DocStudio\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecommendedTemplateResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecommendedTemplateResponseDTO';
    ...
    */
     ...
     *
     * @param string[]|null $shared_to_mailbox_groups shared_to_mailbox_groups
     *
     * @return self
     */
