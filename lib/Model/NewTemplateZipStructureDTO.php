...
/**
 * NewTemplateZipStructureDTO Class Doc Comment
 *
 * @category Class
 * @package  DocStudio\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewTemplateZipStructureDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewTemplateZipStructureDTO';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $title when calling NewTemplateZipStructureDTO., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling NewTemplateZipStructureDTO., must be bigger than or equal to 1.');
        }
