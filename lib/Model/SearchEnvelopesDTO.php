 ...
 */
class SearchEnvelopesDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchEnvelopesDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('active_role', $data ?? [], null);
    ...
    */
     ...
     * Sets deleted
     *
     * @param bool|null $deleted Deleted to Recycle Bin
     *
     * @return self
     */
     ...
     * Sets active_role
     *
     * @param string[]|null $active_role active_role
     *
     * @return self
     */
    public function setActiveRole($active_role)
    {
        if (is_null($active_role)) {
            throw new \InvalidArgumentException('non-nullable active_role cannot be null');
        }
     ...
     * Sets sort_field
     *
     * @param string|null $sort_field Field for sorting ('createdAt' by default)
     *
     * @return self
     */
     ...
     * Gets search_fields
     *
     * @return \DocStudio\Client\Model\SearchFieldValueDTO[]|null
     */
     ...
     * Sets search_fields
     *
     * @param \DocStudio\Client\Model\SearchFieldValueDTO[]|null $search_fields search_fields
     *
     * @return self
     */
