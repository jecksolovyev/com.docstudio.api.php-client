 ...
 */
class BillingProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingProperties';
    ...
    protected static $openAPITypes = [
        'enabled' => 'bool',
        'hide_tariffs' => 'bool',
        'payment_providers' => '\DocStudio\Client\Model\PaymentProviderInfo[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hide_tariffs', $data ?? [], null);
        $this->setIfExists('payment_providers', $data ?? [], null);
        $this->setIfExists('allowed_currencies', $data ?? [], null);
    ...
    */
     ...
     * Sets hide_tariffs
     *
     * @param bool|null $hide_tariffs hide_tariffs
     *
     * @return self
     */
    public function setHideTariffs($hide_tariffs)
    {
        if (is_null($hide_tariffs)) {
            throw new \InvalidArgumentException('non-nullable hide_tariffs cannot be null');
        }
     ...
     *
     * @return \DocStudio\Client\Model\PaymentProviderInfo[]|null
     */
     ...
     *
     * @param \DocStudio\Client\Model\PaymentProviderInfo[]|null $payment_providers payment_providers
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $allowed_currencies allowed_currencies
     *
     * @return self
     */
    public function setAllowedCurrencies($allowed_currencies)
    {
        if (is_null($allowed_currencies)) {
            throw new \InvalidArgumentException('non-nullable allowed_currencies cannot be null');
        }
