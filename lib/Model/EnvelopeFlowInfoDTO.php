 ...
 */
class EnvelopeFlowInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvelopeFlowInfoDTO';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('delegated_to', $data ?? [], null);
    ...
    */
     ...
     * Sets mailbox_name
     *
     * @param string|null $mailbox_name Name of the mailbox role assigned to
     *
     * @return self
     */
     ...
     * Sets delegated_to
     *
     * @param string|null $delegated_to Email of delegate (for invitation)
     *
     * @return self
     */
    public function setDelegatedTo($delegated_to)
    {
        if (is_null($delegated_to)) {
            throw new \InvalidArgumentException('non-nullable delegated_to cannot be null');
        }
     ...
     * Sets type
     *
     * @param string|null $type Role type
     *
     * @return self
     */
     ...
     * Sets completed
     *
     * @param bool|null $completed Role completion status
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int|null $order Role order as defined in template
     *
     * @return self
     */
     ...
     * Sets role_id
     *
     * @param string|null $role_id Role id
     *
     * @return self
     */
