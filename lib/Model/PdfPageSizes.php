...
/**
 * PdfPageSizes Class Doc Comment
 *
 * @category Class
 * @package  DocStudio\Client
 * @author   OpenAPI Generator team
 ...
 */
class PdfPageSizes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PdfPageSizes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('rotations', $data ?? [], null);
    ...
    */
     ...
     * Sets rotations
     *
     * @param int[]|null $rotations rotations
     *
     * @return self
     */
    public function setRotations($rotations)
    {
        if (is_null($rotations)) {
            throw new \InvalidArgumentException('non-nullable rotations cannot be null');
        }
