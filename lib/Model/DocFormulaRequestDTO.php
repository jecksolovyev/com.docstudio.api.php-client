 ...
 */
class DocFormulaRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocFormulaRequestDTO';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('formulas', $data ?? [], null);
    ...
    */
     ...
     * Sets formulas
     *
     * @param array<string,string>|null $formulas formulas
     *
     * @return self
     */
    ...
    {
        if (is_null($formulas)) {
            throw new \InvalidArgumentException('non-nullable formulas cannot be null');
        }
     ...
     * Sets arguments
     *
     * @param array<string,object>|null $arguments arguments
     *
     * @return self
     */
