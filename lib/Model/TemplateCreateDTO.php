 ...
 */
class TemplateCreateDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateCreateDTO';
    ...
    */
     ...
     * Sets categories
     *
     * @param string[]|null $categories Template categories ids and their accessLevels. Null or empty array if not within any category.
     *
     * @return self
     */
     ...
     * Sets shared_to
     *
     * @param string[]|null $shared_to Mailboxes list, which have access to template
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $shared_to_mailbox_groups Mailbox groups, which have access to template
     *
     * @return self
     */
