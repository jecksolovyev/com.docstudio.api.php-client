...
class CategoryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier in DB. Shouldn't be set for creation.
     *
     * @return self
     */
     ...
     * Sets parent_id
     *
     * @param string|null $parent_id Id of parent category
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CategoryDTO., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CategoryDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets access
     *
     * @param string|null $access Access level
     *
     * @return self
     */
