...
/**
 * StampRequestDTO Class Doc Comment
 *
 * @category Class
 * @package  DocStudio\Client
 * @author   OpenAPI Generator team
 ...
 */
class StampRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StampRequestDTO';
    ...
    */
     ...
     * Sets envelope_uuid
     *
     * @param string $envelope_uuid Envelope UUID in order to detect language
     *
     * @return self
     */
     ...
     * Sets signing_date
     *
     * @param \DateTime|null $signing_date Signing date
     *
     * @return self
     */
