...
/**
 * DictionaryColumnValueSearchDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class DictionaryColumnValueSearchDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DictionaryColumnValueSearchDTO';
    ...
    */
     ...
     * Sets envelope_uuid
     *
     * @param string|null $envelope_uuid Envelope UUID, used for filtered dictionaries
     *
     * @return self
     */
     ...
     * Sets template_uuid
     *
     * @param string|null $template_uuid Template UUID, used for filtered dictionaries
     *
     * @return self
     */
     ...
     * Sets version_uuid
     *
     * @param string|null $version_uuid Template version UUID, used for filtered dictionaries
     *
     * @return self
     */
     ...
     * Sets document_id
     *
     * @param string|null $document_id Document id, where field is located, used for filtered dictionaries
     *
     * @return self
     */
     ...
     * Sets field_name
     *
     * @param string|null $field_name Field name, used for filtered dictionaries
     *
     * @return self
     */
     ...
     * Sets row_index
     *
     * @param int|null $row_index Row index, where field is located in table used for filtered dictionaries
     *
     * @return self
     */
     ...
     * Sets keyword
     *
     * @param string|null $keyword Keyword to search by
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param array<string,string>|null $filter Values for filter columns, except filter by role
     *
     * @return self
     */
