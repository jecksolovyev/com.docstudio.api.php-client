...
/**
 * MailboxUpdateRequestDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class MailboxUpdateRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MailboxUpdateRequestDTO';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hide_name_for_accounts', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hide_name_for_accounts'] === null) {
            $invalidProperties[] = "'hide_name_for_accounts' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MailboxUpdateRequestDTO., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MailboxUpdateRequestDTO., must be bigger than or equal to 0.');
        }
     ...
     * Sets aliases
     *
     * @param \DocStudio\Client\Model\AliasNameDTO[] $aliases aliases
     *
     * @return self
     */
    ...
    {
        if (is_null($hide_name_for_accounts)) {
            throw new \InvalidArgumentException('non-nullable hide_name_for_accounts cannot be null');
        }
