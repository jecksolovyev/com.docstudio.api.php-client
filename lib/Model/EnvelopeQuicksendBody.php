 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnvelopeQuicksendBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'envelope_quicksend_body';
    ...
    protected static $swaggerTypes = [
        'files' => 'string[]',
'data' => '\DocStudio\Client\Model\QuickSendDTO'    ];
...
'data' => 'getData'    ];
     ...
     * Sets files
     *
     * @param string[] $files Files for external documents
     *
     * @return $this
     */
