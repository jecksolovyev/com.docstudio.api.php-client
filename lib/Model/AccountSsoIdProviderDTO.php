 ...
 */
class AccountSsoIdProviderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSsoIdProviderDTO';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountSsoIdProviderDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountSsoIdProviderDTO., must be bigger than or equal to 3.');
        }
    ...
    public function setFirstNameMapping($first_name_mapping)
    {
        ...
        if ((mb_strlen($first_name_mapping) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name_mapping when calling AccountSsoIdProviderDTO., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($first_name_mapping) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name_mapping when calling AccountSsoIdProviderDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setLastNameMapping($last_name_mapping)
    {
        ...
        if ((mb_strlen($last_name_mapping) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name_mapping when calling AccountSsoIdProviderDTO., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($last_name_mapping) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name_mapping when calling AccountSsoIdProviderDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneMapping($phone_mapping)
    {
        ...
        if ((mb_strlen($phone_mapping) > 64)) {
            throw new \InvalidArgumentException('invalid length for $phone_mapping when calling AccountSsoIdProviderDTO., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($phone_mapping) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_mapping when calling AccountSsoIdProviderDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setMetadataUrl($metadata_url)
    {
        ...
        if ((mb_strlen($metadata_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $metadata_url when calling AccountSsoIdProviderDTO., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($metadata_url) < 7)) {
            throw new \InvalidArgumentException('invalid length for $metadata_url when calling AccountSsoIdProviderDTO., must be bigger than or equal to 7.');
        }
