...
class ContactDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id UUID of contact record
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Contact name, from 3 to 255 characters
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContactDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContactDTO., must be bigger than or equal to 3.');
        }
