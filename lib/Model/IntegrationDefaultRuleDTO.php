 ...
 */
class IntegrationDefaultRuleDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationDefaultRuleDTO';
    ...
    public const RULE_INBOX = 'inbox';
    public const RULE_INBOX_NOTIFY_EMAIL = 'inbox-notify-email';
    public const RULE_AUTOREJECT = 'autoreject';
    ...
    */
     ...
     * Sets parameter
     *
     * @param string|null $parameter Default rule parameter
     *
     * @return self
     */
