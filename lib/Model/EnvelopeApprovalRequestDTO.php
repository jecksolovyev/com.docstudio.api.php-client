 ...
 */
class EnvelopeApprovalRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvelopeApprovalRequestDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('flow_uuid', $data ?? [], null);
    ...
    */
     ...
     * Sets flow_uuid
     *
     * @param string|null $flow_uuid UUID of saved approval flow (Approvers must not be set)
     *
     * @return self
     */
    public function setFlowUuid($flow_uuid)
    {
        if (is_null($flow_uuid)) {
            throw new \InvalidArgumentException('non-nullable flow_uuid cannot be null');
        }
     ...
     * Gets approvers
     *
     * @return \DocStudio\Client\Model\EnvelopeApproverDTO[]|null
     */
     ...
     * Sets approvers
     *
     * @param \DocStudio\Client\Model\EnvelopeApproverDTO[]|null $approvers Set of approvers (Flow UUID must not be set)
     *
     * @return self
     */
