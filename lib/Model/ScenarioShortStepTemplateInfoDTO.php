 ...
 */
class ScenarioShortStepTemplateInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScenarioShortStepTemplateInfoDTO';
