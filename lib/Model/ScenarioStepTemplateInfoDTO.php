 ...
 */
class ScenarioStepTemplateInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScenarioStepTemplateInfoDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('template_version_uuid', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($template_version_uuid)) {
            throw new \InvalidArgumentException('non-nullable template_version_uuid cannot be null');
        }
