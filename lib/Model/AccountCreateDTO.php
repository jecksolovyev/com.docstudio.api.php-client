    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountCreateDTO., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountCreateDTO., must be bigger than or equal to 3.');
        }
    ...
    public function setInn($inn)
    {
        ...
        if ((mb_strlen($inn) > 128)) {
            throw new \InvalidArgumentException('invalid length for $inn when calling AccountCreateDTO., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($inn) < 8)) {
            throw new \InvalidArgumentException('invalid length for $inn when calling AccountCreateDTO., must be bigger than or equal to 8.');
        }
