 ...
 */
class EnvelopeConfirmInviteRoleDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvelopeConfirmInviteRoleDTO';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $id when calling EnvelopeConfirmInviteRoleDTO., must be smaller than or equal to 2147483647.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling EnvelopeConfirmInviteRoleDTO., must be bigger than or equal to 1.');
        }
