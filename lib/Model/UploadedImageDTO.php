 ...
 */
class UploadedImageDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadedImageDTO';
    ...
    */
    ...
    public function setImageUuid($image_uuid)
    {
        if (is_null($image_uuid)) {
            throw new \InvalidArgumentException('non-nullable image_uuid cannot be null');
        }
