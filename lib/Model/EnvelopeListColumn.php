...
/**
 * EnvelopeListColumn Class Doc Comment
 *
 * @category Class
 * @package  DocStudio\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnvelopeListColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvelopeListColumn';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hideable', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['hideable'];
    }

    /**
     * Sets hideable
     *
     * @param bool|null $hideable hideable
     *
     * @return self
     */
    ...
    {
        if (is_null($hideable)) {
            throw new \InvalidArgumentException('non-nullable hideable cannot be null');
        }
        $this->container['hideable'] = $hideable;
