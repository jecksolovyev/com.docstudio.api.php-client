...
/**
 * EnvelopeWithFlow Class Doc Comment
 *
 * @category Class
 * @package  DocStudio\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnvelopeWithFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvelopeWithFlow';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flow_uuid'] === null) {
            $invalidProperties[] = "'flow_uuid' can't be null";
        }
     ...
     * Sets flow_uuid
     *
     * @param string $flow_uuid flow_uuid
     *
     * @return self
     */
